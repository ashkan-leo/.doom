...
+ GTD workflow files.
#+BEGIN_SRC emacs-lisp
(setq! pipboy/org-notes (expand-file-name "~/w/org-roam-files/")
       pipboy/bibtex-files (directory-files "~/Documents/Library/bib/" 'full ".bib")
       pipboy/gtd-directory (expand-file-name "~/Dropbox/beorg"))
#+END_SRC
** Get Things Done
*** Files
...
(use-package! org-ref
  ...
  :after org-mode
  :config
  (setq! org-ref-bibliography-notes (concat pipboy/org-notes "/bibnotes.org") ;; FIXME make this more explicit
         ...
         org-ref-pdf-directory "~/Documents/Library/pdf/" ;; FIXME define this in My Paths section
