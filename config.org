...
#+end_src
** Main Theme
I'm obsessed with the dark solarized theme, but the it looks blue in my
terminal. So I use zenburn if I'm in the terminal.

#+begin_src emacs-lisp
;; (if (display-graphic-p)
;;     (progn (setq! doom-theme 'doom-solarized-dark))
...
(setq! leot/documents-directory "~/Documents" ;; Root Documents directory -- potentially in iCloud drive
       ...
       org-tickler-file-name (expand-file-name "tickler.org" org-gtd-files-directory)
       org-someday-file-name (expand-file-name "someday.org" org-gtd-files-directory)
       org-gtd-file-name (expand-file-name "gtd.org" org-gtd-files-directory)
